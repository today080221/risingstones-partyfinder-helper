...
release/risingstones-partyfinder-helper-v0.1.11-win-x64.zip.sha256
```

## 发布包内容

```text
risingstones-partyfinder-helper-v0.1.11-win-x64/
...
```powershell
Get-FileHash .\risingstones-partyfinder-helper-v0.1.11-win-x64.zip -Algorithm SHA256
```
...
```text
release/risingstones-partyfinder-helper-v0.1.11-win-x64.zip
SHA256: D4E3D8CAC340686C147783A41EE86F98368CCDFA2E68177E70BA59A18369835D
```
