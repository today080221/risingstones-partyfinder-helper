...
release/阿谢姆水晶（Azem's Crystal）-v1.0.0-win-x64.zip.sha256
```

## 发布包内容

```text
阿谢姆水晶（Azem's Crystal）-v1.0.0-win-x64/
...
```powershell
Get-FileHash '.\阿谢姆水晶（Azem''s Crystal）-v1.0.0-win-x64.zip' -Algorithm SHA256
```
