...
release/risingstones-partyfinder-helper-v0.1.7-win-x64.zip.sha256
```

## 发布包内容

```text
risingstones-partyfinder-helper-v0.1.7-win-x64/
...
```powershell
Get-FileHash .\risingstones-partyfinder-helper-v0.1.7-win-x64.zip -Algorithm SHA256
```
