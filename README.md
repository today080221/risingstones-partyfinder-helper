...
```text
risingstones-partyfinder-helper-v0.1.7-desktop-win-x64-portable.zip
```
...
```text
risingstones-partyfinder-helper-v0.1.7-win-x64.zip
```
...
```text
release/risingstones-partyfinder-helper-v0.1.7-desktop-win-x64-portable.zip
```
...
```text
release/risingstones-partyfinder-helper-v0.1.7-win-x64.zip
```
