...
阿谢姆水晶（Azem's Crystal）是一个面向 FF14 中国大陆服务器石之家副本招募页面的本地筛选工具。它会在你选定副本后，按官方筛选条件顺序拉取完整分页，再在本地按进度、攻略、时间、空缺职业和队伍位置筛选。
...
- GitHub：https://github.com/today080221/risingstones-partyfinder-helper/releases/tag/v1.0.3
- Gitee：https://gitee.com/jianwen1126/risingstones-partyfinder-helper/releases/tag/v1.0.3
...
- 数据范围：
  ...
  - 24 人团队 A/B/C
- 本地筛选：
  - 标签/类型筛选，统一作用于石之家标签和 NGA 解析标签；多选默认全部命中，可用“任一命中”小按钮切换为任一标签命中
  - 进度关键词，支持包含和 `-排除`
  - 攻略关键词，支持包含和 `-排除`
  - 全局不包含关键词
  - 原文时间关键词
...
- 结果卡片：
  ...
  - 当前队伍构成
  - 需求职业
  - 官方详情按钮；桌面版会打开系统默认浏览器，网页版会打开新标签页
  - 空位位置
  - 大区/服务器
  - 响应数和剩余时间
  - 按需展开队伍详情、招募要求、攻略说明
